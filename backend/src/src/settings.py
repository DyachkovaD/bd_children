...
# Папка frontend — на одном уровне с backend (родитель BASE_DIR = backend/src -> parent = backend -> parent = bd_children)
...
SECRET_KEY = 'django-insecure-d-)@+2jgfq3abe72mm%joxy%6n=wdf&_q$s&)v*9ojs_0tg&b='
